        ...
        <div class="row">
            <div class="col-sm">
                <div class="crd mx-auto">
                    <h2 class="subheading">Create Table</h2>
                    <form method="POST" action="#" class="mt-4 d-flex flex-column">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Server Name</label>
                            <input name="servername" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Server" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="tablename" type="text" class="form-control" id="exampleInputTableName1" placeholder="TableName" />
                        </div>
            ...
            <div class="col-sm">
                <div class="crd mx-auto">
                    <h2 class="subheading">Create Table</h2>
                    <form method="POST" action="../php/create_table.php" class="mt-4 d-flex flex-column">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Server Name</label>
                            <div class="card">
                                <div class="card-body">
